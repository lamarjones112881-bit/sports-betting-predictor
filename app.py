...
with tab_tracker:
    ...
    with settle_cols[1]:
        settlement_sport = st.selectbox("Settlement sport", ["NBA", "NFL"], index=0 if sport == "NBA" else 1, key="settlement_sport")
